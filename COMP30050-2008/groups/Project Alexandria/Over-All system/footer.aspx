...
<form id="form1" runat="server">
	<div style="position: absolute; width: 1062px; height: 28px; z-index: 1; left: 8px; top: 584px" id="layer5">
&nbsp;&nbsp; Copyright Alexandria © 2008&nbsp;&nbsp; All rights reserved<SCRIPT type=text/javascript>
...
//-->
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
		&nbsp;&nbsp;
		<asp:LinkButton runat="server" id="LinkButton1">Contact Admin</asp:LinkButton>
	&nbsp;&nbsp;&nbsp;&nbsp;
