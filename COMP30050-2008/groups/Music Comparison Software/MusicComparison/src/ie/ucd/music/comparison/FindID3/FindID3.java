	...
	public static void main (String args[]){
       ...
       if((args.length!=0)||(args.length>9)) {
         ...
         if  ( alldirs )
         {
          ...
          try
         {
          //System.out.println("searching for mp3s in directories"+args[1] +" and " + args[0]);
          //=============================Read ID3 code
                 ...
                 { 
                	 System.out.println("file input error error message was e = " + e.toString());
                        }
                 }
         ...
         System.out.println("Author Peter O' Murchu. This program reads in two directories and extracts all mp3 files from them  ");
         System.out.println("Possible errors: 1.You must enter at least two directories. 2.The directories you entered do not exist");
                 }
         ...
         try{
           ...
           } else //System.out.println(mp3 + " does not contain"  + "ID3 info."); 
           file.close();
          }
          catch(Exception e)
   ...
   for( int i = 0; i<allFiles.length; i++)
                 {
                  ...
                  //String extension = allFilesi].substring(allFiles[i].length - 3, allFiles[i].length); 
        	   String tempfname = allFiles
        	   [i].getName();
                                 
     if((tempfname.endsWith("mp3"))||(tempfname.endsWith("MP3"))||(tempfname.endsWith("mP3"))||(tempfname.endsWith("Mp3"))){
       System.out.println("========================= ");
