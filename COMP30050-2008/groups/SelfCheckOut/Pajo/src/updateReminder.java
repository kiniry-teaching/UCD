//updateReminder - a class that allows you to update the reminders set by a user, used either by
//the gui at finish and pay time, or by the website
//replaces addReminder.java
//@author Pajo
//
import java.sql.*;
...
public class updateReminder {
	...
	public updateReminder (int custID, String[] reminderarray) {
		try{
			...
			PreparedStatement pstmt = conn.prepareStatement("REPLACE INTO Reminder(CustomerID,Item1BC,Item2BC,Item3BC,Item4BC,Item5BC,Item6BC,Item7BC,Item8BC,Item9BC,Item10BC) VALUES(?,?,?,?,?,?,?,?,?,?,?)");
