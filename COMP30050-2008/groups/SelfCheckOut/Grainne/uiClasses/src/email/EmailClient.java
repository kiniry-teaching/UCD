...
public class EmailClient extends JFrame //implements ActionListener
{
    ...
    static String currentOtheringredients;
    static String currentInstructions;
    static Recipe currentRecipe;
    static LinkedList<String> currentTransaction;
    String emailBody = messageBodyIntro + currentRecipename + currentOtheringredients + currentInstructions;
    ...
    public static void addComponentsToPane(final Container pane) 
    {
       ...
       //add recipes to the email body 
        messageBodyField.add(currentRecipename, messageBodyField);
    	messageBodyField.add(currentOtheringredients, messageBodyField);
    	messageBodyField.add(currentInstructions, messageBodyField);
    	
    	//get lists of items in the transaction

    	 for (int i = 0; i < currentTransaction.size(); i++) 
    	 {
    		 messageBodyField.add(currentTransaction.get(i),messageBodyField);
    	 }
    ...
    public static void main(String[] args) {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
            	customerName = currentCustomer.myname;
            	customerEmail = currentCustomer.myemailaddress;
            	currentRecipename= currentRecipe.recipename;
                currentOtheringredients=currentRecipe.otheringredients;
