...
namespace Drought.Graphics.Particles
{
    ...
    public abstract class ParticleSystem
    {
        ...
        /// Constructor.
        /// </summary>
        protected ParticleSystem(ContentManager content, GraphicsDevice graphics)
        {
            this.content = content;
            InitializeSettings(settings);
            particles = new ParticleVertex[settings.MaxParticles];
            LoadParticleEffect(graphics);
        ...
        /// </summary>
        void LoadParticleEffect(GraphicsDevice graphics)
        {
            Effect effect = content.Load<Effect>("EffectFiles/particles");
            ...
            particleEffect = effect.Clone(graphics);
        ...
        /// </summary>
        public void render(GameTime gameTime, GraphicsDevice device)
        {
