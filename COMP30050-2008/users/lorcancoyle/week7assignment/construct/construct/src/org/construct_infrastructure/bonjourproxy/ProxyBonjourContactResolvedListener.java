 ...
 */
public interface ProxyBonjourContactResolvedListener {
    ...
    */
   void contactResolved(ProxyBonjourContact the_contact);
    ...
    */
   void resolveFailed(ProxyBonjourContact the_contact, String a_message);
}
