...
namespace TuneBlaster_
{
    ...
    public class Engine : Microsoft.Xna.Framework.Game
    {
        ...
        public Engine()
        {
            ...
            core = new Core();
            ball = new MovingBall(core, MovingBall.value.red);
            ball2 = new MovingBall(core, MovingBall.value.red);
        }
        ...
        protected override void Initialize()
        {
            ...
            ball.Initialise(new Vector2(50f,50f),new Vector2(100f,400f));
            ball2.Initialise(new Vector2(50f, 50f), new Vector2(800f, 800f));
            base.Initialize();
        }
        ...
        protected override void LoadGraphicsContent(bool loadAllContent)
        {
            if (loadAllContent)
            {
                ...
                ball2.LoadGraphicsContent(spriteBatch, texture);
