...
/**
 * This class contains the information required to store, and resolve the necessary details to
 * set up a bonjour contact ready for gossiping.
 * 
 * @author Graham Williamson (graham.williamson@ucd.ie)
 * @author Graeme Stevenson (graeme.stevenson@ucd.ie)
 */
public class ProxyBonjourContact implements ResolveListener, QueryListener {
    ...
    */
   private ProxyBonjourContactResolvedListener my_listener;

   /**
    * Creates a new BonjourContact object. Resolves the IP address and port number of the named
    * service.
    * 
    * @param a_nodeID
    ...
    *           The iterface on which the service can be reached.
    */
   public ProxyBonjourContact(final String a_nodeID, final String a_domain,
         final String a_type, final int an_ifIndex) {
   ...
   /**
    * Resolve this bonjour contact to discover the IP address and port number associated with
    * the service.
    * 
    * @param a_listener
    *           The listener to notify when the service is resolved.
    * @throws DNSSDException
    *            if there is a problem resolving the IP and port number from the contact
    *            information.
    */
   public final void resolve(final ProxyBonjourContactResolvedListener a_listener)
      throws DNSSDException {
   ...
   /**
    * Callback to this method invoked from resolve call in the constructor. Allows us to get a
    * handle on the port.
    * 
    * @param a_resolver
   ...
   /**
    * Callback to this method invoked from query call in the serviceResolved method. Allows us
   ...
   /**
    * Called if an error occurs using service registration or the browse request.
    * 
    * @param a_service
    ...
    * 
    * @return True if this contact has been resolved to an IP address and port number.
    */
   ...
   public final boolean equals(final Object a_contact) {
      ...
      if (a_contact instanceof ProxyBonjourContact) {
         final ProxyBonjourContact other = (ProxyBonjourContact) a_contact;
         if (my_nodeID.equals(other.my_nodeID) && my_domain.equals(other.my_domain)
