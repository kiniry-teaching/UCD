 ...
 */
public class QueryViewerPanel extends JPanel {

   /**
    * A SPARQL query which returns all the data currently in the datastore.
    */
   public static final String QUERY_ALL_DATA = "SELECT ?subject ?predicate ?object WHERE "
    ...
    * The clear button.
    */
   private JButton my_clearButton;

   /**
    * Allow the user to enter a custom query, the results of which will be displayed in the
    * table.
    */
    ...
    */
   private final QueryViewerImpl my_owner;
    ...
    */
   public QueryViewerPanel(final QueryViewerImpl the_owner) {
      super();
      my_owner = the_owner;
      initGUI();
   }
   ...
   private JPanel getButtonPanel() {
      if (my_buttonPanel == null) {
         ...
         my_buttonPanel.add(getClearButton(), null);
      }
      return my_buttonPanel;
   }

   /**
    * This method initializes my_clearButton.
    * 
    * @return javax.swing.JButton
    */
   private JButton getClearButton() {
      if (my_clearButton == null) {
         my_clearButton = new JButton();
         my_clearButton.setText("Clear View");
         my_clearButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(final java.awt.event.ActionEvent an_event) {
               my_owner.reset();
            }
         });
      }
      return my_clearButton;
   }
   ...
   /**
    * Set the model that this QueryViewer will display.
    * 
    * @param a_tableModel
    *           The model to display in the QueryViewer window.
    */
