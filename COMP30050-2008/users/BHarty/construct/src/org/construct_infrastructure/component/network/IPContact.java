...
/**
 * A IPContact represents a process which may be contacted via IP to gossip
 * with.
 * 
 * @author Graham Williamson (graham.williamson@ucd.ie)
 */
public interface IPContact extends Contact {
   ...
   /**
    * Get the port this contact listens on.
    * 
    * @return The port this contact listens on.
    */
   int getPort();
}
