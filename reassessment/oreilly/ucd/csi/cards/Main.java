...
//		System.out.println(Ace + " " + King +" " + Queen + " " + Jack + " " + Ten);		
//		System.out.println(RoyalFlush);
		
//		check for isFullHouse
		PokerHand fullHouse = new PokerHand();
		Card hThree = new PokerCard(Card.HEART, Card.THREE);
		Card sThree = new PokerCard(Card.SPADE, Card.THREE);
		Card dThree = new PokerCard(Card.DIAMOND, Card.THREE);
		Card hTwo = new PokerCard(Card.HEART, Card.TWO);
		Card sTwo = new PokerCard(Card.SPADE, Card.TWO);
		fullHouse.addCard(sTwo);
		fullHouse.addCard(hTwo);
		fullHouse.addCard(dThree);
		fullHouse.addCard(sThree);
		fullHouse.addCard(hThree);
		System.out.println(sTwo + " " + hTwo + " " + dThree + " " + sThree + " " + hThree);
