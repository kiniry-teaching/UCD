 ...
 * @revised Naomi O'Reilly <naomi.oreilly@ucdconnect.ie />
 * @see http://secure.ucd.ie/~kiniry/part4.txt
 */

public class PokerHand {
/**
* the cards in our vector hand.
*/
...
/**
 * holds the handValue for each hand.
 */
...
//5 == the number of cards in a pokerHand.
      int  lengthOfHand = 5;
      if (hand.size() < lengthOfHand) {
          hand.add(c);
       }
     if (hand.size() == lengthOfHand) {
         computePokerHand();
...
*
*/
    public final void removeCard(final Card c) {
        hand.remove(c);
    }
...
/**
 *
 * @return true iff the cards contained on hand make a royal flush.
 */
...
/**
 *
 * @return true iff the cards contained in the hand
 *  vector make a straight flush.
 */
...
/**
 *
 * @return true iff there are four card with the same value in the deck.
 */
    private boolean isFourOfAKind() {
//4 is to check if there are four of a kind
//when count == 4 four of a kind == true.
      int fourCards = 4;
...
/**
 *
 * @return true iff the cards in the hand make up a full house i.e.
...
/**
 *
 * @return true iff cards is the hand equal a flush.
 */
...
/**
 *
 * @return true iff the cards in the hand equal a straight.
 */
...
/**
 *
 * @return true iff the hand contains three cards with the same value.
 *
 */
    private boolean isThreeOfAKind() {
     // if count == threeOfAKind isThreeOfAKind == true.
        int threeOfAKind = 3;
        if (isFullHouse()) {
            return false;
        } else {
...
/**
 *
 * @return true iff there is a pair of cards with the same value.
 */
...
*/
    public final int compare(PokerHand h) {
