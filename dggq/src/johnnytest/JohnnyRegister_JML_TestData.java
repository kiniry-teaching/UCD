 ...
 */
public abstract class JohnnyRegister_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public JohnnyRegister_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for JohnnyRegister");
    }
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vjohnnycash_JohnnyCardIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vjohnnycash_JohnnyCardStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * johnnycash.JohnnyCard. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vjohnnycash_JohnnyCardStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    return TestDataGenerator.getJohnnyCard(n);
                }
            };

    /** Return a new, freshly allocated indefinite iterator that
     * produces test data of type 
     * johnnycash.JohnnyBank
     * for testing the method named by the String methodName in
     * a loop that encloses loopsThisSurrounds many other loops.
     * @param methodName name of the method for which this
     *                      test data will be used.
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vjohnnycash_JohnnyBankIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vjohnnycash_JohnnyBankStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * johnnycash.JohnnyBank. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vjohnnycash_JohnnyBankStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    return TestDataGenerator.getJohnnyBank(n);
                }
            };

    /** Return a new, freshly allocated indefinite iterator that
     * produces test data of type 
     * johnnycash.JohnnyRegister
     * for testing the method named by the String methodName in
     * a loop that encloses loopsThisSurrounds many other loops.
     * @param methodName name of the method for which this
     *                      test data will be used.
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vjohnnycash_JohnnyRegisterIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vjohnnycash_JohnnyRegisterStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * johnnycash.JohnnyRegister. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vjohnnycash_JohnnyRegisterStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    return TestDataGenerator.getJohnnyRegister(n);
                }
            };

    /** Return a new, freshly allocated indefinite iterator that
     * produces test data of type 
     * johnnycash.JohnnyTransaction
     * for testing the method named by the String methodName in
     * a loop that encloses loopsThisSurrounds many other loops.
     * @param methodName name of the method for which this
     *                      test data will be used.
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vjohnnycash_JohnnyTransactionIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vjohnnycash_JohnnyTransactionStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * johnnycash.JohnnyTransaction. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vjohnnycash_JohnnyTransactionStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    return TestDataGenerator.getJohnnyTransaction(n);
                }
            };
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vjohnnycash_JohnnyTransaction$_Iter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vjohnnycash_JohnnyTransaction$_Strategy.iterator();
    }

    /** The strategy for generating test data of type
     * johnnycash.JohnnyTransaction[]. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vjohnnycash_JohnnyTransaction$_Strategy
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return TestDataGenerator.getJohnnyTransactionArray();
                }

                //@ also
                //@ requires o$ != null;
                protected Object cloneElement(java.lang.Object o$) {
                    johnnycash.JohnnyTransaction[] down$
                        = (johnnycash.JohnnyTransaction[]) o$;
                    return down$.clone();
                }
            };
}
