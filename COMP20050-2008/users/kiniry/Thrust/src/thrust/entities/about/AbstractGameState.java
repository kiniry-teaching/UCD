...
public abstract class AbstractGameState {
  ...
  public interface HighScoreInterface {
    /** The number of initials in a high score. */
    int NUMBER_OF_INITIALS = 3;
    ...
    //@ ensures \result.length == NUMBER_OF_INITIALS;
    /*@ pure @*/ char[] initials();
    ...
    //@ requires the_new_initials.length == NUMBER_OF_INITIALS;
    ...
    //@ invariant initials().length == NUMBER_OF_INITIALS;
  }
}
