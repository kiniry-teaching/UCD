...
public abstract /*@ pure @*/ class AbstractGameState {
   ...
   * @write The current fuel of the spaceship.
   ...
   * @write The maximum fuel of the spaceship.
   */
  //@ ensures 0 <= \result;
  ...
  public abstract /*@ pure @*/ boolean new_high_score(/*@ non_null @*/
  HighScoreInterface the_possible_new_high_score);

  public abstract void add_high_score(/*@ non_null @*/
  HighScoreInterface the_new_high_score);
