// This file was generated by jmlunit on Sun May 10 13:46:09 BST 2009.
    ...
    extends junit.framework.TestCase
{
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vcashsystem_JohnnyRegisterIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vcashsystem_JohnnyRegisterStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * cashsystem.JohnnyRegister. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vcashsystem_JohnnyRegisterStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    switch (n) {
                      case 0: return new JohnnyRegister(1, "string1", new JohnnyBank());
                    default:
                        break;
                    }
                    throw new java.util.NoSuchElementException();
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vcashsystem_JohnnyBankIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vcashsystem_JohnnyBankStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * cashsystem.JohnnyBank. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vcashsystem_JohnnyBankStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    switch (n) {
                        case 0: return new JohnnyBank();
                    default:
                        break;
                    }
                    throw new java.util.NoSuchElementException();
