 ...
 */
public abstract class JohnnyTrannie_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public JohnnyTrannie_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for JohnnyTrannie");
    }
        ...
        = new org.jmlspecs.jmlunit.strategies.CharStrategy()
            {
                protected char[] addData() {
                    return new char[] {
                        JohnnyTrannie.PURCHASE_TYPE, JohnnyTrannie.UPLOAD_TYPE, 'M'
                    };
                }
            };
        ...
        = new org.jmlspecs.jmlunit.strategies.IntStrategy()
            {
                protected int[] addData() {
                    return TestDataGenerator.getIntRange();
                }
            };
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vniall_JohnnyCardIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vniall_JohnnyCardStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * niall.JohnnyCard. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vniall_JohnnyCardStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    switch (n) {
                    case 0 : return TestDataGenerator.getDefaultCard();
                    case 1 : return TestDataGenerator.getCardWithCash();
                    case 2: return TestDataGenerator.getLockedCard();
                    default:
                        break;
                    }
                    throw new java.util.NoSuchElementException();
