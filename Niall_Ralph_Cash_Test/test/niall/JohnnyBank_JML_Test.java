     ...
     extends JohnnyBank_JML_TestData
{
    ...
    */
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                ...
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vniall_JohnnyBankIter("getBalance", 0));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vniall_JohnnyBankIter(\"getBalance\", 0))");
            while (!receivers$iter.atEnd()) {
                final niall.JohnnyBank receiver$
                    = (niall.JohnnyBank) receivers$iter.get();
                methodTests$.addTest
    ...
    protected static class TestGetBalance extends OneTest {
        /** The receiver */
        private niall.JohnnyBank receiver$;

        /** Initialize this instance. */
        public TestGetBalance(niall.JohnnyBank receiver$) {
            super("getBalance");
        ...
        (junit.framework.TestSuite overallTestSuite$)
    {
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                receivers$iter
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vniall_JohnnyBankIter("validatePin", 1));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vniall_JohnnyBankIter(\"validatePin\", 1))");
            while (!receivers$iter.atEnd()) {
                ...
                while (!vint$1$iter.atEnd()) {
                    ...
                    final int thePIN
                        = vint$1$iter.getInt();
                    methodTests$.addTest
                        (new TestValidatePin(receiver$, thePIN));
                    vint$1$iter.advance();
                }
                receivers$iter.advance();
            }
    ...
    protected static class TestValidatePin extends OneTest {
        ...
        /** Initialize this instance. */
        public TestValidatePin(niall.JohnnyBank receiver$, int thePIN) {
            super("validatePin"+ ":" + thePIN);
            this.receiver$ = receiver$;
            this.thePIN = thePIN;
        }

        protected void doCall() throws java.lang.Throwable {
            receiver$.validatePin(thePIN);
        }
        ...
        (junit.framework.TestSuite overallTestSuite$)
    {
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                receivers$iter
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vniall_JohnnyBankIter("updateBalance", 1));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vniall_JohnnyBankIter(\"updateBalance\", 1))");
            while (!receivers$iter.atEnd()) {
                org.jmlspecs.jmlunit.strategies.IntIterator
                    vint$1$iter
                    = this.vintIter("updateBalance", 0);
                this.check_has_data
                    (vint$1$iter,
                     "this.vintIter(\"updateBalance\", 0)");
                while (!vint$1$iter.atEnd()) {
                    ...
                    final int theAmount
                        = vint$1$iter.getInt();
                    methodTests$.addTest
                        (new TestUpdateBalance(receiver$, theAmount));
                    vint$1$iter.advance();
                }
                receivers$iter.advance();
            }
    ...
    protected static class TestUpdateBalance extends OneTest {
        ...
        /** Initialize this instance. */
        public TestUpdateBalance(niall.JohnnyBank receiver$, int theAmount) {
            super("updateBalance"+ ":" + theAmount);
            this.receiver$ = receiver$;
            this.theAmount = theAmount;
        }

        protected void doCall() throws java.lang.Throwable {
            receiver$.updateBalance(theAmount);
        }
