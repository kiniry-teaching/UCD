// This file was generated by jmlunit on Wed May 06 11:02:12 BST 2009.
 ...
 */
public abstract class JohnnyMachine_JML_TestData
    extends junit.framework.TestCase
{
    /** Initialize this class. */
    public JohnnyMachine_JML_TestData(java.lang.String name) {
        super(name);
    }
    ...
    public junit.framework.TestSuite overallTestSuite() {
        return new junit.framework.TestSuite("Overall tests for JohnnyMachine");
    }
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vjohnny_JohnnyMachineIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vjohnny_JohnnyMachineStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * johnny.JohnnyMachine. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vjohnny_JohnnyMachineStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    switch (n) {
                    case 0:
                    	return new JohnnyMachine(new JohnnyBank[]{new JohnnyBank(0,new int[]{1,2,3,4})}) ;
                    case 1:
                    	return new JohnnyMachine(new JohnnyBank[]{new JohnnyBank(0,new int[]{1,2,3,4}),new JohnnyBank(1,new int[]{4,3,2,1})}) ;
                    default:
                        break;
                    }
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vjohnny_JohnnyBank$_Iter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vjohnny_JohnnyBank$_Strategy.iterator();
    }

    /** The strategy for generating test data of type
     * johnny.JohnnyBank[]. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vjohnny_JohnnyBank$_Strategy
        = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy()
            {
                protected java.lang.Object[] addData() {
                    return new johnny.JohnnyBank[][] {
                    		{new JohnnyBank(0,new int[]{1,2,3,4}),new JohnnyBank(1,new int[]{4,3,2,1})},
                    		{new JohnnyBank(0,new int[]{1,2,3,4})},
                    		{new JohnnyBank(0,new int[]{1,2,3,4}),new JohnnyBank(1,new int[]{4,3,2,1})}
                    };
                }
    ...
    //@ ensures \fresh(\result);
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vjohnny_JohnnyCardIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vjohnny_JohnnyCardStrategy.iterator();
    }

    /** The strategy for generating test data of type
     * johnny.JohnnyCard. */
    private org.jmlspecs.jmlunit.strategies.StrategyType
        vjohnny_JohnnyCardStrategy
        = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy()
            {
                protected Object make(int n) {
                    switch (n) {
                    case 0:
                    	return new JohnnyCard(0,0) ;
                    case 1:
                    	return new JohnnyCard(0,1) ;
                    case 2:
                    	return new JohnnyCard(1,0) ;
                    default:
                        break;
                    }
                    throw new java.util.NoSuchElementException();
