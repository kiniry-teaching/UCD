     ...
     extends JohnnyRegister_JML_TestData
{
    ...
    */
        ...
        (junit.framework.TestSuite overallTestSuite$)
    {
        ...
        try {
            this.addTestSuiteFor$TestTransferCash(overallTestSuite$);
        } catch (java.lang.Throwable ex) {
            overallTestSuite$.addTest
                (new org.jmlspecs.jmlunit.strategies.ConstructorFailed(ex));
        }
        ...
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                ...
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vjohnny_JohnnyRegisterIter("acceptCard", 1));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vjohnny_JohnnyRegisterIter(\"acceptCard\", 1))");
            while (!receivers$iter.atEnd()) {
                ...
                while (!vjohnny_JohnnyCard$1$iter.atEnd()) {
                    final johnny.JohnnyRegister receiver$
                        = (johnny.JohnnyRegister) receivers$iter.get();
    ...
    protected static class TestAcceptCard extends OneTest {
        /** The receiver */
        private johnny.JohnnyRegister receiver$;
        /** Argument submittedCard */
        private johnny.JohnnyCard submittedCard;

        /** Initialize this instance. */
        public TestAcceptCard(johnny.JohnnyRegister receiver$, johnny.JohnnyCard submittedCard) {
    ...
    /** Add tests for the transferCash method
     * to the overall test suite. */
    private void addTestSuiteFor$TestTransferCash
        (junit.framework.TestSuite overallTestSuite$)
    {
        junit.framework.TestSuite methodTests$
            = this.emptyTestSuiteFor("transferCash");
        try {
            org.jmlspecs.jmlunit.strategies.IndefiniteIterator
                receivers$iter
                = new org.jmlspecs.jmlunit.strategies.NonNullIteratorDecorator
                    (this.vjohnny_JohnnyRegisterIter("transferCash", 1));
            this.check_has_data
                (receivers$iter,
                 "new NonNullIteratorDecorator(this.vjohnny_JohnnyRegisterIter(\"transferCash\", 1))");
            while (!receivers$iter.atEnd()) {
                org.jmlspecs.jmlunit.strategies.IntIterator
                    vint$1$iter
                    = this.vintIter("transferCash", 0);
                this.check_has_data
                    (vint$1$iter,
                     "this.vintIter(\"transferCash\", 0)");
                while (!vint$1$iter.atEnd()) {
                    ...
                    final int amount
                        = vint$1$iter.getInt();
                    methodTests$.addTest
                        (new TestTransferCash(receiver$, amount));
                    vint$1$iter.advance();
                }
                receivers$iter.advance();
            }
    ...
    /** Test for the transferCash method. */
    protected static class TestTransferCash extends OneTest {
        /** The receiver */
        private johnny.JohnnyRegister receiver$;
        /** Argument amount */
        private int amount;
        ...
        /** Initialize this instance. */
        public TestTransferCash(johnny.JohnnyRegister receiver$, int amount) {
            super("transferCash"+ ":" + amount);
            this.receiver$ = receiver$;
            this.amount = amount;
        }

        protected void doCall() throws java.lang.Throwable {
            receiver$.transferCash(amount);
        }

        protected java.lang.String failMessage
            (org.jmlspecs.jmlrac.runtime.JMLAssertionError e$)
        {
            java.lang.String msg = "\n\tMethod 'transferCash' applied to";
            msg += "\n\tReceiver: " + this.receiver$;
